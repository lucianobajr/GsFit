...
class _AppointmentState extends State<Appointment> {
  ...
  var db = new DbHelper();
  var dbTeste = new DbAjudante();

  List<People> _listPeople = <People>[
                  ...
                  child: Column(
                    children: <Widget>[
                     ...
                     // Expanded(
                      ...
                      //       itemBuilder: (context, index) {
                      //         final people = _listPeople[index];
  ...
  void _getPeople() async {
    List people = await dbTeste.recuperarTodosAfazeres();
    people.forEach((person) {
      setState(() {
        _listPeople.add(People.map(person));
      });
    });
  }
}
