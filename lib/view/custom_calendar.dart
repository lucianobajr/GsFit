import 'package:gsfit/view/hotel_app_theme.dart';
...
class _CustomCalendarViewState extends State<CustomCalendarView> {
  ...
  var format = initializeDateFormatting("pt_BR", null);
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(
                  child: Center(
                    child: Text(
                      DateFormat('MMMM, yyyy','pt_BR').format(currentMonthDate),
                      style: TextStyle(
    ...
    for (int i = 0; i < 7; i++) {
      listUI.add(
        Expanded(
          child: Center(
            child: Text(
              DateFormat('EEE','pt_BR').format(dateList[i]),
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
